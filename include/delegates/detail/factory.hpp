...
static IDelegate* make_method_delegate(TClass* callee,
                                       TResult (TClass::*method)(TArgs...),
                                       DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult, typename... TArgs>
static IDelegate* make_function_delegate(TResult f(TArgs...), DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult, typename... TArgs>
static IDelegate* make_function_delegate(std::function<TResult(TArgs...)> func, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
  return new FunctionalDelegate<TResult, TArgs...>(func, std::move(params));
}

template <typename TResult=void, typename... TArgs, typename F>
static IDelegate* make_lambda_delegate(F && lambda, DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <class TClass, typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared_method_delegate(
  TClass* callee, TResult (TClass::*method)(TArgs...), DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared_function_delegate(
  TResult f(TArgs...), DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
  return std::make_shared<FunctionalDelegate<TResult, TArgs...> >(
...
template <typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared_function_delegate(
  std::function<TResult(TArgs...)> func, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult=void, typename... TArgs, typename F>
static std::shared_ptr<IDelegate> make_shared_lambda_delegate(F && lambda, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <class TClass, typename TResult, typename... TArgs>
static std::unique_ptr<IDelegate> make_unique_method_delegate(
  std::shared_ptr<TClass> callee, TResult (TClass::*method)(TArgs...), DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
  return std::make_unique<SharedMethodDelegate<TClass, TResult, TArgs...> >(
    callee, method, std::move(params));
}
...
template <typename TResult=void, typename... TArgs, typename F>
static std::unique_ptr<IDelegate> make_unique_lambda_delegate(F && lambda, DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult=void, typename... TArgs, typename F>
static IDelegate* make(F && lambda, DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult=void, typename... TArgs>
static ISignal* make_signal(DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TClass, typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared(std::shared_ptr<TClass> callee, TResult(TClass::* method)(TArgs...), DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TClass, typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared(const TClass* callee, TResult(TClass::* method)(TArgs...) const, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TClass, typename TResult, typename... TArgs>
static std::shared_ptr<IDelegate> make_shared(std::shared_ptr<TClass> callee, TResult(TClass::* method)(TArgs...) const, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
  return make_shared_const_method_delegate<TClass, TResult, TArgs...>(callee, method, std::move(params));
}
...
template <typename TResult=void, typename... TArgs, typename F>
static std::shared_ptr<IDelegate> make_shared(F&& lambda, DelegateArgs<TArgs...>&& params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult=void, typename... TArgs>
static std::shared_ptr<ISignal> make_shared_signal(DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
...
template <typename TResult=void, typename... TArgs>
static std::unique_ptr<ISignal> make_unique_signal(DelegateArgs<TArgs...> && params = DelegateArgs<TArgs...>(std::nullptr_t{})) {
